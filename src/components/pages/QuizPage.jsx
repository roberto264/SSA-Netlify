...
import { ArrowLeft, Trophy, XCircle, Check, X, Loader2 } from 'lucide-react';
...
export function QuizPage() {
  ...
  if (modulesLoading || !modules) {
    return (
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8 flex items-center justify-center min-h-[50vh]">
